(() => {
  ...
  var e, t, n = {
      285: (e, t, n) => {
        e.exports = n.p + "0b468cbd71c94e8dba54.wasm"
      },
      931: (e, t, n) => {
        e.exports = n.p + "3bdf3e0dcd052d14d278.wasm"
      }
    },
    i = {};
  ...
  s.m = n, s.d = (e, t) => {
  ...
  }, s.f = {}, s.e = e => Promise.all(Object.keys(s.f).reduce(((t, n) => (s.f[n](e, t), t)), [])), s.u = e => "core.ruffle." + {
    662: "73cd4b2216766003e577",
    966: "bca1371f982df7946ed0"
  }[e] + ".js", s.g = function () {
  ...
  }), e), s.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, t = "ruffle-selfhosted:", s.l = (n, i, r, o) => {
    if (e[n]) e[n].push(i);
    else {
      var a, l;
      if (void 0 !== r)
      ...
      var h = (t, i) => {
          ...
          var s = e[n];
          if (delete e[n], a.parentNode && a.parentNode.removeChild(a), s && s.forEach((e => e(i))), t) return t(i)
        },
    ...
    const e = async() => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 14, 1, 12, 0, 65, 0, 65, 0, 65, 0, 252, 10, 0, 0, 11])),
      t = async() => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 7, 1, 5, 0, 208, 112, 26, 11])),
      n = async() => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 12, 1, 10, 0, 67, 0, 0, 0, 0, 252, 0, 26, 11])),
      i = async() => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 8, 1, 6, 0, 65, 0, 192, 26, 11])),
      r = async() => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
    ...
    function l(e) {
      let t = a;
      return null !== e.publicPath && void 0 !== e.publicPath && (t = e.publicPath), "" === t || t.endsWith("/") || (t += "/"), t
    }
    let c = null;

    function u(a, u) {
      return null === c && (c = async function (a, c) {
        "function" == typeof Array.prototype.reduce && o(Array.prototype.reduce) || Object.defineProperty(Array.prototype, "reduce", {
          value(...e) {
        ...
        }), "function" == typeof Window && o(Window) || "function" == typeof window.constructor && o(window.constructor) && (window.Window = window.constructor), void 0 === window.Reflect && (window.Reflect = {}), "function" != typeof Reflect.get && Object.defineProperty(Reflect, "get", {
          value: (e, t) => e[t]
        ...
        u || console.log("Some WebAssembly extensions are NOT available, falling back to the vanilla WebAssembly module"), s.p = l(a);
        const {
          default: d,
          Ruffle: h
        } = await (u ? s.e(966).then(s.bind(s, 966)) : s.e(662).then(s.bind(s, 662)));
        let f;
        ...
        if (c) {
          ...
          let t = 0;
          const n = parseInt(e);
          f = new Response(new ReadableStream({
            async start(e) {
              var i;
              ...
              for (c(t, n);;) {
                ...
                if (i) break;
                (null == r ? void 0 : r.byteLength) && (t += null == r ? void 0 : r.byteLength), e.enqueue(r), c(t, n)
              }
              e.close()
            }
          }), m)
    ...
    function f(e, t) {
      ...
      if (void 0 !== window.customElements)
        for (; n < 999;) {
          let i = e;
          if (n > 0 && (i = i + "-" + n), void 0 === window.customElements.get(i)) return window.customElements.define(i, t), h[e] = {
            class: t,
            name: i,
            internalName: e
          }, i;
    ...
    class E extends HTMLElement {
      constructor() {
        return super(), this.contextMenuForceDisabled = !1, this.isTouch = !1, this.loadedConfig = p, this.panicked = !1, this.isExtension = !1, this.config = {}, this.shadow = this.attachShadow({
          mode: "open"
        }), this.shadow.appendChild(d.content.cloneNode(!0)), this.dynamicStyles = this.shadow.getElementById("dynamic_styles"), this.container = this.shadow.getElementById("container"), this.playButton = this.shadow.getElementById("play_button"), this.playButton && this.playButton.addEventListener("click", (() => this.play())), this.unmuteOverlay = this.shadow.getElementById("unmute_overlay"), this.preloader = this.shadow.getElementById("preloader"), this.contextMenuElement = this.shadow.getElementById("context-menu"), this.addEventListener("contextmenu", this.showContextMenu.bind(this)), this.addEventListener("pointerdown", this.pointerDown.bind(this)), this.addEventListener("fullscreenchange", this.fullScreenChange.bind(this)), this.addEventListener("webkitfullscreenchange", this.fullScreenChange.bind(this)), window.addEventListener("click", this.hideContextMenu.bind(this)), this.instance = null, this.onFSCommand = null, this._readyState = 0, this._metadata = null, this.lastActivePlayingState = !1, this.setupPauseOnTabHidden(), this
      }
      get readyState() {
      ...
      async ensureFreshInstance() {
        ...
        const t = await u(this.loadedConfig, this.onRuffleDownloadProgress.bind(this)).catch((e => {
        ...
        if (this.instance = await new t(this.container, this, this.loadedConfig), console.log("New Ruffle instance created (WebAssembly extensions: " + (t.is_wasm_simd_used() ? "ON" : "OFF") + ")"), "running" !== this.audioState() && (this.container.style.visibility = "hidden", await new Promise((e => {
            window.setTimeout((() => {
              e()
            }), 200)
          })), this.container.style.visibility = ""), this.unmuteAudioContext(), "on" === this.loadedConfig.autoplay || "off" !== this.loadedConfig.autoplay && "running" === this.audioState()) {
          if (this.play(), "running" !== this.audioState()) {
            "hidden" !== this.loadedConfig.unmuteOverlay && (this.unmuteOverlay.style.display = "block"), this.container.addEventListener("click", this.unmuteOverlayClicked.bind(this), {
              once: !0
            });
      ...
      checkOptions(e) {
        ...
        return t(null !== e && "object" == typeof e, "Argument 0 must be a string or object"), t("url" in e || "data" in e, "Argument 0 must contain a `url` or `data` key"), t(!("url" in e) || "string" == typeof e.url, "`url` must be a string"), e
      }
      async load(e) {
        var t, n;
        if (e = this.checkOptions(e), this.isConnected && !this.isUnusedFallbackObject()) {
          if (!q(this)) try {
            if (this.loadedConfig = Object.assign(Object.assign(Object.assign(Object.assign({}, p), null !== (n = null === (t = window.RufflePlayer) || void 0 === t ? void 0 : t.config) && void 0 !== n ? n : {}), this.config), e), this.loadedConfig.allowScriptAccess = !0 === e.allowScriptAccess, this.loadedConfig.backgroundColor && "transparent" !== this.loadedConfig.wmode && (this.container.style.backgroundColor = this.loadedConfig.backgroundColor), await this.ensureFreshInstance(), "url" in e) {
              console.log(`Loading SWF file ${e.url}`), this.swfUrl = new URL(e.url, document.baseURI);
              const t = Object.assign(Object.assign({}, k(e.url.substring(e.url.indexOf("?")))), k(e.parameters));
              this.instance.stream_from(this.swfUrl.href, t)
            } else "data" in e && (console.log("Loading SWF data"), this.instance.load_data(new Uint8Array(e.data), k(e.parameters)))
          } catch (e) {
      ...
      async downloadSwf() {
        try {
          if (this.swfUrl) {
            ...
            i.style.display = "none", i.href = n, i.download = function (e) {
              const t = e.pathname;
              return t.substring(t.lastIndexOf("/") + 1)
            }(this.swfUrl), document.body.appendChild(i), i.click(), document.body.removeChild(i), URL.revokeObjectURL(n)
      ...
      contextMenuItems() {
        ...
        })), this.instance && this.swfUrl && !0 === this.loadedConfig.showSwfDownload && (t.push(null), t.push({
          text: "Download .swf",
        ...
        return t.push({
          text: `About Ruffle ${n} (nightly 2022-09-29)`,
          onClick() {
      ...
      showContextMenu(e) {
        if (e.preventDefault(), !1 === this.loadedConfig.contextMenu || this.contextMenuForceDisabled) return;
      ...
      unmuteAudioContext() {
        x || (navigator.maxTouchPoints < 1 ? x = !0 : this.container.addEventListener("click", (() => {
          var e;
          if (x) return;
          const t = null === (e = this.instance) || void 0 === e ? void 0 : e.audio_context();
          if (!t) return;
      ...
      panic(e) {
        ...
        if (this.panicked = !0, this.hidePreloader(), e instanceof Error && ("AbortError" === e.name || e.message.includes("AbortError"))) return;
        ...
        const s = i.join(""),
          r = new Date("2022-09-29T00:19:25.847Z"),
          o = new Date;
        ...
        if (a) l = `<a target="_top" href="${y}#downloads">Update Ruffle</a>`;
          ...
          i.stackIndex > -1 && String(t + n).length > 8195 && (i[i.stackIndex] = null, i.avmStackIndex > -1 && (i[i.avmStackIndex] = null), n = encodeURIComponent(i.join(""))), t += n, l = `<a target="_top" href="${t}">Report Bug</a>`
        }
        switch (n) {
        case 2:
        ...
        case 10:
          ...
          break;
        case 5:
          c = "\n                    <p>Ruffle has encountered a major issue whilst trying to initialize.</p>\n                    <p>It seems like this page uses JavaScript code that conflicts with Ruffle.</p>\n                    <p>If you are the server administrator, we invite you to try loading the file on a blank page.</p>\n                ", a && (c += "<p>You can also try to upload a more recent version of Ruffle that may circumvent the issue (current build is outdated: 2022-09-29T00:19:25.847Z).</p>"), u = `\n                    <li>${l}</li>\n                    <li><a href="#" id="panic-view-details">View Error Details</a></li>\n                `;
          break;
        case 1:
          c = '\n                    <p>Ruffle has encountered a major issue whilst trying to initialize.</p>\n                    <p>This web server\'s Content Security Policy does not allow the required ".wasm" component to run.</p>\n                    <p>If you are the server administrator, please consult the Ruffle wiki for help.</p>\n                ', u = '\n                    <li><a target="_top" href="https://github.com/ruffle-rs/ruffle/wiki/Using-Ruffle#configure-wasm-csp">View Ruffle Wiki</a></li>\n                    <li><a href="#" id="panic-view-details">View Error Details</a></li>\n                ';
          break;
        default:
          c = "<p>Ruffle has encountered a major issue whilst trying to display this Flash content.</p>", c += a ? "<p>If you are the server administrator, please try to upload a more recent version of Ruffle (current build is outdated: 2022-09-29T00:19:25.847Z).</p>" : "<p>This isn't supposed to happen, so we'd really appreciate if you could file a bug!</p>", u = `\n                    <li>${l}</li>\n                    <li><a href="#" id="panic-view-details">View Error Details</a></li>\n                `
        }
      ...
      setMetadata(e) {
        this._metadata = e, this._readyState = 2, this.hidePreloader(), this.dispatchEvent(new Event(E.LOADED_METADATA)), this.dispatchEvent(new Event(E.LOADED_DATA))
      }
      setIsExtension(e) {
        this.isExtension = e
      }
    ...
    function _(e) {
      if (e) {
        ...
        if (t.startsWith("/v/") && ("youtube.com" === n || "youtube-nocookie.com" === n)) return !0
      }
      return !1
    }
    ...
    function A(e, t) {
      ...
      if (s) try {
        const n = new URL(s);
        "http:" === n.protocol && "https:" === window.location.protocol && !1 !== r.upgradeToHttps && (n.protocol = "https:", e.setAttribute(t, n.toString()))
      } catch (e) {}
    }
      ...
      connectedCallback() {
        ...
        if (m) {
          const g = null !== (t = null === (e = this.attributes.getNamedItem("allowScriptAccess")) || void 0 === e ? void 0 : e.value) && void 0 !== t ? t : null,
            v = null !== (i = null === (n = this.attributes.getNamedItem("menu")) || void 0 === n ? void 0 : n.value) && void 0 !== i ? i : null;
          this.load({
            url: m.value,
    ...
    class M extends E {
      ...
      connectedCallback() {
        ...
        if (t) {
          ...
          e.allowScriptAccess = I(n, t), i && (e.parameters = i), s && (e.backgroundColor = s), r && (e.base = r), e.menu = S(o), a && (e.salign = a), l && (e.quality = l), c && (e.scale = c), u && (e.wmode = u), this.load(e)
        }
      }
      debugPlayerInfo() {
        var e;
      ...
      static isInterdictable(e) {
        ...
        if (o === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase()) return !Array.from(e.getElementsByTagName("object")).some(M.isInterdictable) && !Array.from(e.getElementsByTagName("embed")).some(N.isInterdictable);
        if (o) return !1;
      ...
      static fromNativeObjectElement(e) {
        const t = f("ruffle-object", M),
          n = document.createElement(t);
        for (const t of Array.from(e.getElementsByTagName("embed"))) N.isInterdictable(t) && t.remove();
        for (const t of Array.from(e.getElementsByTagName("object"))) M.isInterdictable(t) && t.remove();
        return n.copyElement(e), n
      }
    }
    var U, D;
    let $;
    const B = null !== (D = null === (U = window.RufflePlayer) || void 0 === U ? void 0 : U.config) && void 0 !== D ? D : {},
      W = l(B) + "ruffle.js";
    let V, H, z, Z;

    function Y() {
      try {
        V = null != V ? V : document.getElementsByTagName("object"), H = null != H ? H : document.getElementsByTagName("embed");
    ...
    function Q() {
      z = null != z ? z : document.getElementsByTagName("iframe"), Z = null != Z ? Z : document.getElementsByTagName("frame"), [z, Z].forEach((e => {
    ...
    async function G(e, t) {
      ...
      if ($ || void 0 === i.documentElement.dataset.ruffleOptout)
        if ($) e.RufflePlayer || (e.RufflePlayer = {}), e.RufflePlayer.config = Object.assign(Object.assign({}, B), null !== (n = e.RufflePlayer.config) && void 0 !== n ? n : {});
        else if (!e.RufflePlayer) {
        const t = i.createElement("script");
        t.setAttribute("src", W), t.onload = () => {
    ...
    class J {
      constructor(e, t, n, i, s) {
        this.major = e, this.minor = t, this.patch = n, this.prIdent = i, this.buildIdent = s
      }
      static fromSemver(e) {
        const t = e.split("+"),
          n = t[0].split("-"),
        ...
        let r = 0,
          ...
          a = null,
          l = null;
        return void 0 !== i[1] && (r = parseInt(i[1], 10)), void 0 !== i[2] && (o = parseInt(i[2], 10)), void 0 !== n[1] && (a = n[1].split(".")), void 0 !== t[1] && (l = t[1].split(".")), new J(s, r, o, a, l)
      }
      isCompatibleWith(e) {
    ...
    class X {
      ...
      satisfiedBy(e) {
        for (let t = 0; t < this.requirements.length; t += 1) {
          ...
          for (let i = 0; i < this.requirements[t].length; i += 1) {
            ...
            n = n && r.isStableOrCompatiblePrerelease(e), "" === s || "=" === s ? n = n && r.isEqual(e) : ">" === s ? n = n && e.hasPrecedenceOver(r) : ">=" === s ? n = n && (e.hasPrecedenceOver(r) || r.isEqual(e)) : "<" === s ? n = n && r.hasPrecedenceOver(e) : "<=" === s ? n = n && (r.hasPrecedenceOver(e) || r.isEqual(e)) : "^" === s && (n = n && r.isCompatibleWith(e))
          }
          if (n) return !0
        }
        return !1
      ...
      static fromRequirementString(e) {
        ...
        return n.length > 0 && i.push(n), new X(i)
      }
    }
    const K = {
      version: "0.1.0",
      polyfill(e) {
        ! function (e) {
          $ = e, Y(), Q(), new MutationObserver((function (e) {
    ...
    class ee {
      constructor(e) {
        this.sources = {}, this.config = {}, this.invoked = !1, this.newestName = null, this.conflict = null, null != e && (e instanceof ee ? (this.sources = e.sources, this.config = e.config, this.invoked = e.invoked, this.conflict = e.conflict, this.newestName = e.newestName, e.superseded()) : e.constructor === Object && e.config instanceof Object ? this.config = e.config : this.conflict = e), "loading" === document.readyState ? document.addEventListener("readystatechange", this.init.bind(this)) : window.setTimeout(this.init.bind(this), 0)
      }
      get version() {
        return "0.1.0"
      }
      ...
      satisfying(e) {
        const t = X.fromRequirementString(e);
        let n = null;
      ...
      static negotiate(e, t) {
        let n;
        return n = e instanceof ee ? e : new ee(e), void 0 !== t && (n.registerSource(t), !1 !== n.config.polyfills && K.pluginPolyfill()), n
      }
    }
